...
const GrayTwo = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("http://localhost:3000/eventThree", form)
      .then((res) => {
        console.log(res);
      })
      .catch((err) => {
    ...
    <div className="p-10 bg-purple-950">
      ...
      <div className="text-center items-center justify-center mt-4">
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <button className="bg-blue-800 h-10 rounded-2xl text-white font-bold">
            Submit
          </button>
        </form>
      </div>
